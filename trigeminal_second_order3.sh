...
out_dir=${o}
nb_thread=${t}
step_size=${step_size} # before : step_size:-0.5
theta=${theta}


fa_threshold= 0.01    # befoe was 0.20   
...
echo "Tracking params: step=${step_size}, theta=${theta}"
...
do
    ...
    echo "|------------- 1) Registrations -------------|"    # before was antsRegistrationSyNQuick
  ...
  -o "${out_dir}/${nsub}/orig_space/transfo/2orig_"
    ...
    do
        ...
        scil_tracking_local ${subject_dir}/${nsub}/tractoflow/${nsub}__fodf.nii.gz \
            ...
            scil_tractogram_math concatenate  ${orig_tracking_dir}/orig/${nsub}_${nside}_from_cp.trk
    done
    echo "|------------- 4) Done -------------|"
    echo ""
